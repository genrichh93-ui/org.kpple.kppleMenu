...
plasmoidName=$(python3 -c "import json; print(json.load(open('$DIR/../metadata.json'))['KPlugin']['Id'])")
website=$(python3 -c "import json; print(json.load(open('$DIR/../metadata.json'))['KPlugin']['Website'])")
bugAddress="$website"
